...
export const DOCX_PREVIEW_MAX_ARCHIVE_ENTRIES = 1_024;
export const DOCX_PREVIEW_MAX_ENTRY_BYTES = 16 * 1024 * 1024;
export const DOCX_PREVIEW_MAX_EXPANDED_BYTES = 32 * 1024 * 1024;
export const DOCX_PREVIEW_MAX_COMPRESSION_RATIO = 200;
